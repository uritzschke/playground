package playground.rcp.hyperbola.editor;
...
public class ChatEditor extends EditorPart {
	...
	public static final String ID = "playground.rcp.hyperbola.editors.chat";
	...
	private void scrollToEnd() {
		final int n = transcript.getCharCount();
		transcript.setSelection(n, n);
		transcript.showSelection();
	}

	private void sendMessage() {
		final String body = entry.getText();
		if (body.length() == 0) {
			return;
		}
